...
Gem::Specification.new do |s|
  ...
  s.authors = ["Tony Pitale", "Igor Barroso"]
  s.date = %q{2011-06-30}
  s.email = %q{tony.pitale@viget.com igor.irb@gmail.com}
  ...
  s.homepage = %q{http://github.com/vigetlabs/garb https://github.com/igorirb/garb}
  s.require_paths = ["lib"]
